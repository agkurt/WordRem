...
class LoginScreenView: UIView {
    ...
    let signInButton = UIComponentsHelper.createCustomButton(buttonTitle: "Sign In", titleColor: UIColor.white, buttonBackGroundColor: UIColor.init(hex: "#00B4D8"), UIColorName: "Poppins-SemiBold")
    let registerButton = UIComponentsHelper.createCustomButton(buttonTitle: "New User? Create Account", titleColor: UIColor.init(hex: "#00B4D8"), buttonBackGroundColor: UIColor.clear, UIColorName: "Poppins-SemiBold")
    let forgotPasswordButton = UIComponentsHelper.createCustomButton(buttonTitle: "Forgot Password?", titleColor: UIColor.init(hex: "#00B4D8"), buttonBackGroundColor: UIColor.clear, UIColorName: "Poppins-SemiBold")
    ...
    private func configureUI() {
        ...
        signInButton.anchor(top: passwordTextField.bottomAnchor, paddingTop: 20, bottom:nil, paddingBottom: 0, left: nil, paddingLeft: 0, right: nil, paddingRight: 0, width: 250, height: 60, centerXAnchor: centerXAnchor, centerYAnchor:nil)
